...
#'
#' Plots a densitiy of a chosen continuous variable, conditioned on self selected quantiles of
...
plot_single_selected_quantile_density <- function(dataset, given_var, firstquant = NA, secondquant = NA, thirdquant = NA, var_to_plot) {
