...
test_that("sum_stats automatically removes factors and logicals from the dataset", {
  ...
  expect_message(sum_stats(iris, "Sepal.Length", n_stats = 4, n_quantiles = 5),
...
test_that("sum_stats calculated the unconditional moments if n_quantiles = 1", {
  ...
  expect_equal(sum_stats(iris, "Sepal.Length", n_stats = 4, n_quantiles = 1)[[1]][1],
               mean(iris$Sepal.Length))
  expect_equal(sum_stats(iris, "Sepal.Length", n_stats = 4, n_quantiles = 1)[[1]][2],
               mean(iris$Sepal.Width))
  expect_equal(sum_stats(iris, "Sepal.Length", n_stats = 4, n_quantiles = 1)[[2]][1],
               var(iris$Sepal.Length))
  expect_equal(sum_stats(iris, "Sepal.Length", n_stats = 4, n_quantiles = 1)[[3]][1],
               moments::skewness(iris$Sepal.Length))
  expect_equal(sum_stats(iris, "Sepal.Length", n_stats = 4, n_quantiles = 1)[[4]][1],
